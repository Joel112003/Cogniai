🧠 CogniAI An intelligent,modern web app built with React,Express,and MongoDB -- enhanced with framer Motion Animations,Skiper UI components, and deployed using CI/CD pipelines.
